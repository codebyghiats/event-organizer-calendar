...
<head>
    ...
    <title>Kalender Event Sekolah - User View</title>
    ...
    <aside class="w-72 bg-white border-r border-gray-200 flex flex-col h-full shrink-0">
        ...
        <div class="flex-1 overflow-y-auto sidebar-scroll">
            ...
            <div class="px-6 py-4 border-t border-gray-100">
                <h3 class="font-semibold text-sm text-gray-900 mb-3">Filter Event</h3>
                <div class="space-y-3">
    ...
    <main class="flex-1 flex flex-col h-full overflow-hidden bg-white">
        ...
        <header class="h-20 border-b border-gray-200 flex items-center justify-between px-8 shrink-0">
            <div class="flex items-center space-x-4">
                ...
                <span class="px-3 py-1 bg-gray-100 text-gray-600 text-xs font-medium rounded-full">View Only</span>
            </div>
            <!-- No Add Button for User View -->
        ...
        <div x-show="currentView === 'agenda'" class="flex-1 overflow-y-auto px-8 pb-8" x-cloak>
            <div class="max-w-3xl mx-auto">
                <!-- Sample Events for Agenda View -->
                <template x-for="day in getAgendaDays()">
                    <div class="mb-6">
                        <div class="flex items-center space-x-3 mb-3">
                            <div class="text-center bg-blue-600 text-white rounded-lg px-4 py-2">
                                <div class="text-xs uppercase font-medium" x-text="getDayName(day.date)"></div>
                                <div class="text-2xl font-bold" x-text="getDayNumber(day.date)"></div>
                            </div>
                            <div class="text-lg font-medium text-gray-900" x-text="formatFullDate(day.date)"></div>
                        </div>
                        <div class="ml-[88px] space-y-2">
                            <div x-show="filters.osis && getDayNumber(day.date) === 9" class="flex items-start space-x-3 p-4 bg-blue-50 rounded-lg border-l-4 border-blue-600 cursor-pointer hover:bg-blue-100 transition-colors">
                                <i class="ri-user-smile-line text-blue-600 text-xl"></i>
                                <div class="flex-1">
                                    <div class="font-semibold text-blue-800">Rapat OSIS Bulanan</div>
                                    <div class="text-sm text-blue-600">08:00 - 10:00</div>
                                    <div class="text-sm text-gray-500"><i class="ri-map-pin-line mr-1"></i>Ruang Guru</div>
                                </div>
                            </div>
                            <div x-show="filters.ekstrakulikuler && getDayNumber(day.date) === 11" class="flex items-start space-x-3 p-4 bg-orange-50 rounded-lg border-l-4 border-orange-500 cursor-pointer hover:bg-orange-100 transition-colors">
                                <i class="ri-football-line text-orange-500 text-xl"></i>
                                <div class="flex-1">
                                    <div class="font-semibold text-orange-800">Kegiatan Pramuka</div>
                                    <div class="text-sm text-orange-600">13:00 - 15:00</div>
                                    <div class="text-sm text-gray-500"><i class="ri-map-pin-line mr-1"></i>Lapangan Sekolah</div>
                                </div>
                            </div>
                            <div x-show="filters.akademik && getDayNumber(day.date) === 13" class="flex items-start space-x-3 p-4 bg-purple-50 rounded-lg border-l-4 border-purple-500 cursor-pointer hover:bg-purple-100 transition-colors">
                                <i class="ri-book-open-line text-purple-500 text-xl"></i>
                                <div class="flex-1">
                                    <div class="font-semibold text-purple-800">Ujian Tengah Semester</div>
                                    <div class="text-sm text-purple-600">07:00 - 12:00</div>
                                    <div class="text-sm text-gray-500"><i class="ri-map-pin-line mr-1"></i>Ruang Kelas</div>
                                </div>
                            </div>
                            <div x-show="filters.lomba && getDayNumber(day.date) === 14" class="flex items-start space-x-3 p-4 bg-red-50 rounded-lg border-l-4 border-red-500 cursor-pointer hover:bg-red-100 transition-colors">
                                <i class="ri-trophy-line text-red-500 text-xl"></i>
                                <div class="flex-1">
                                    <div class="font-semibold text-red-800">Lomba Debat Bahasa Inggris</div>
                                    <div class="text-sm text-red-600">09:00 - 12:00</div>
                                    <div class="text-sm text-gray-500"><i class="ri-map-pin-line mr-1"></i>Aula Utama</div>
                                </div>
                            </div>
                            <div x-show="!filters.osis && !filters.ekstrakulikuler && !filters.akademik && !filters.lomba && !filters.mpk && !filters.libur" class="text-gray-400 text-sm italic p-4 bg-gray-50 rounded-lg">
